       ...
       function motionCorrectDecorr(obj)
        ...
        function returnVal = addNextRawDataSetCorrected_c_old(obj)
            ...
            if(~isempty(nextDataSet))
                ...
                tau=10^3/obj.frameRate;
                if(isempty(obj.cumulativeDecorr))
                    temp = obj.cumulativeShamDecorr;
                    obj.cumulativeDecorr = ((temp - obj.cumulativeShamDecorr)./(1/tau-obj.cumulativeShamDecorr))/tau;
                    ...
                    tempDec = ((obj.cumulativeDecorr - obj.cumulativeShamDecorr)./(1/tau-obj.cumulativeShamDecorr))/tau;
        ...
        function returnVal = addNextRawDataSetCorrected_c(obj)
            ...
            if(~isempty(nextDataSet))
                ...
                tau=10^3/obj.frameRate;
                if(isempty(obj.cumulativeDecorr))
                    obj.uncorrectedCumulativeDecorr = max(obj.cumulativeShamDecorr, dataObj.decorr);
                    obj.cumulativeDecorr = ((temp - obj.cumulativeShamDecorr)./(1/tau-obj.cumulativeShamDecorr))/tau;
                    obj.cumulativeDecorr(obj.cumulativeDecorr <0) = realmin;
                    obj.cumulativeDecorrROI = obj.cumulativeDecorr.*obj.ROIMap;
                    obj.decorrAverageSeries(obj.numDataSets) = sum(obj.cumulativeDecorr(:))/numel(obj.cumulativeDecorr(:));
